...
merkurius.position.x += 30;
merkurius.position.y += -100;
...
t1.to(obj.position,{y:1000,duration:20});

let t2 = gsap.timeline({paused:true});
t2.to(matahari.position,{y:335,duration:20});

let t3 = gsap.timeline({paused:true});
t3.to(merkurius.position,{y:315,duration:20});

let t4 = gsap.timeline({paused:true});
t4.to(venus.position,{y:315,duration:21});
